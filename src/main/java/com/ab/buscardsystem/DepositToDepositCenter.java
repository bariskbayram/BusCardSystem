...
public class DepositToDepositCenter {
    ...
    public void createDepositToDepositCenterReceipt(double amount, double payment) {
        depositToDepositCenterReceipt = new DepositToDepositCenterReceipt(amount,payment);
